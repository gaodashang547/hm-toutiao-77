      ...
      <div slot="header">
        ...
        <div class="img_list">
            <div class="img_item" v-for="item in images" :key="item.id">
                ...
                <div class="foot">
                    <span class="el-icon-star-off" :class="{selected:item.is_collected}" @click="toggle(item)"></span>
...
export default {
  ...
  methods: {
    async toggle (item) {
      const { data: { data } } = await this.$http.put(`http://ttapi.research.itcast.cn/mp/v1_0/user/images/${item.id}`, { collect: !item.is_collected })
    ...
    async getImages () {
      const { data: { data } } = await this.$http.get('http://ttapi.research.itcast.cn/mp/v1_0/user/images', { params: this.reqParams })
